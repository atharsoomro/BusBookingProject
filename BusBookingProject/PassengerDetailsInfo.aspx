        ...
        <div class="row" id="paymentMode" runat="server">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="1" Text="UBL"></asp:ListItem>
                                <asp:ListItem Value="2" Text="HBL"></asp:ListItem>
                                <asp:ListItem Value="3" Text="BANK AL HABIB"></asp:ListItem>
                                <asp:ListItem Value="4" Text="ALPHALA BANK"></asp:ListItem>
                                <asp:ListItem Value="5" Text="ISLAMIC BANK"></asp:ListItem>
                            </asp:DropDownList>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            <asp:Label ID="lblLastName" runat="server" Text="PIN Code" Font-Bold="true"></asp:Label>
